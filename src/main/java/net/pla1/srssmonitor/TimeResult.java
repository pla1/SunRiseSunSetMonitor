...
public class TimeResult {
    ...
    public String getSunriseDateDisplay() {
        return Utils.getDateDisplay(getSunriseDate());
    }

    public String getSunsetDateDisplay() {
        return Utils.getDateDisplay(getSunsetDate());
    }

    public Date getSunriseDate() {
        try {
            return new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ssXXX").parse(sunrise);
    ...
    public Date getSunsetDate() {
        try {
            return new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ssXXX").parse(sunset);
        } catch (ParseException e) {
            e.printStackTrace();
        }
        return null;
